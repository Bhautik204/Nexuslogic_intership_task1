  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-3xl space-y-8">
        ...
        <div id="videos" className="p-6 max-w-3xl mx-auto bg-white/20 backdrop-blur-lg rounded-lg shadow-lg mb-8">
          ...
          <div id="performances" className="mt-8">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              ...
              {performances.map((perf) => (
                <Card key={perf.performanceId} className="mb-4 shadow-lg hover:shadow-lg overflow-hidden transition transform hover:scale-105 flex flex-col">
                  <CardHeader>
                  ...
                  <CardContent>
                    <Button
                      className="mt-2 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full shadow-lg hover:shadow-xl hover:bg-gradient-to-l transition"
                    >
                      Book Now
                    </Button>
                  </CardContent>
                  ...
                  >
                    ...
                    <div className="p-4 flex-grow flex flex-col justify-between">
                      ...
                      <button
                        ...
                        className="mt-4 w-full px-4 py-2 text-white bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full shadow-lg hover:shadow-xl hover:bg-gradient-to-l transition"
                      >
                        View Songs
                      </button>
                    </div>
                  ...
                  >
                    ...
                    <div className="p-4 flex-grow flex flex-col justify-between">
                      ...
                      <button
                        ...
                        className="mt-6 w-full px-4 py-2 text-white bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full shadow-lg hover:shadow-xl hover:bg-gradient-to-l transition"
                      >
                        View Bundle
                      </button>
                    </div>
