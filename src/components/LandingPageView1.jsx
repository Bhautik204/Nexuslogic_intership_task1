      ...
      <div className="max-w-6xl mx-auto px-4 py-8 pt-[100px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8">
            ...
            <div id="videos" className="p-6 max-w-3xl mx-auto bg-white/20 backdrop-blur-lg rounded-lg shadow-lg m-8">
              <Card className="bg-transparent">
                <CardHeader className="border-b border-transparent">
                  <CardTitle className="text-2xl font-bold text-gray-100">Music Videos</CardTitle>
                </CardHeader>
                <CardContent>
                      ...
                      >
                        <div className="relative group">
                          ...
                          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-t-lg flex flex-col justify-end">
                            {/* Title in Overlay */}
                            <h3 className="text-white font-semibold text-lg p-4 text-center">{video.title}</h3>
                            {/* Button */}
            ...
            <ScrollArea className="">
              ...
              <div id="performances" className="mt-8">
                <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
                  ...
                  {performances.map((perf) => (
                    <div key={perf.performanceId} className="bg-white rounded-lg p-4 mb-4 shadow-md">
                      <div className="mb-2">
                        <h3 className="text-xl font-semibold text-gray-800">{perf.eventTitle}</h3>
              ...
              <div id="songsSale" className="py-12">
                <div className="p-8 max-w-5xl mx-auto bg-gradient-to-r from-blue-50/40 to-blue-200/40 backdrop-blur-md rounded-2xl shadow-xl">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    {songSales.map((song) => (
                      <div
                        key={song.songId}
                        className="bg-white rounded-lg shadow-md hover:shadow-lg overflow-hidden transform hover:scale-105 transition flex flex-col"
                      >
                        {/* Image Section */}
                        ...
                        <div className="p-6 flex-grow flex flex-col justify-between">
                          <div>
                            ...
                            <p className="text-gray-700 font-medium">
                              ...
                              {song.price && (
                                <span className="text-green-600"> - ${song.price}</span>
                              )}
                            </p>
                          </div>
                          <button
                            onClick={() => window.open(song.redirectURL, "_blank")}
                            className="mt-6 px-6 py-3 text-white bg-gradient-to-r from-blue-500 to-blue-700 rounded-full shadow-md hover:shadow-lg transition"
                          >
                            View Songs
                          </button>
                        </div>
                    ...
                    {merchandise.map((merc) => (
                      ...
                      >
                        ...
                        <div className="p-4 flex-grow flex flex-col justify-between">
                          ...
                          <button
className="mt-6 w-full px-4 py-2 text-white bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full shadow-lg hover:shadow-xl hover:bg-gradient-to-l transition hover:text-gray-300 focus:ring-2 focus:ring-offset-2 focus:ring-gray-800"
>
                            View Bundle
                          </button>
                        </div>
                ...
                {fanMessages && (
                  <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
                    ...
                    <Card className="mb-4">
                      ...
                      <CardContent>
                        <Button className="bg-gradient-to-r from-light-blue to-aqua rounded-full shadow-md hover:shadow-lg hover:scale-105 transition"
                        >
                          Send Message
                        </Button>
                      </CardContent>
              ...
              {/* Support Section */}
              <div id="support" className="py-12">
                {supportPage && (
                  <div className="p-6 max-w-3xl mx-auto bg-gradient-to-b from-white/50 to-gray-100/50 backdrop-blur-md rounded-2xl shadow-2xl">
                    {/* Section Title */}
                    ...
                    <Card className="bg-white shadow-lg rounded-xl">
                      ...
                      <CardContent className="p-6 flex justify-center">
                        <Button
                          className="px-6 py-3 text-lg font-medium text-white bg-gradient-to-r from-light-blue to-aqua rounded-full shadow-md hover:shadow-lg hover:scale-105 transition"
                          onClick={() => window.open(supportPage.redirectURL, "_blank")}>
                          Support Now
                        </Button>
                      </CardContent>
                    </Card>
